 ...
 * generated in the com.mycomp.training.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSum_QNAME = new QName("http://ws.training.mycomp.com/", "calculateSum");
    private final static QName _CalculateSumResponse_QNAME = new QName("http://ws.training.mycomp.com/", "calculateSumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycomp.training.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.training.mycomp.com/", name = "calculateSum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.training.mycomp.com/", name = "calculateSumResponse")
